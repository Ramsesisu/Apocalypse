...
import org.apocalypse.core.monster.type.Baby;
import org.apocalypse.core.monster.type.Wolf;
...
public class DeadEnd extends Map {
    ...
    public DeadEnd() {
        super("Dead End", new Location(17, 67, 23, -30),
                List.of(Zombie.class, Wolf.class, Baby.class),
                List.of(new Area("Street", new Location(22, 68, 26),
                        ...
                        new Area("Hotel", new Location(2, 69, 18), new Door("Hotel", new Location(11, 68, 22), new Location(11, 71, 20), new Location(12, 68, 21), 750),
