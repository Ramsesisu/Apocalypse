...
public class LocationUtils {
    ...
    public static Location get(String x, String y, String z) {
        return get(Integer.parseInt(x), Integer.parseInt(y), Integer.parseInt(z));
    }
    ...
    public static String getFormatted(Location loc) {
        DecimalFormat df = new DecimalFormat("#.#", new DecimalFormatSymbols(Locale.ENGLISH));
        return "new Location(LocationUtils.WORLD, " + df.format(loc.getX()) + ", " + df.format(loc.getY()) + ", " + df.format(loc.getZ()) + ", " + df.format(loc.getYaw()) + "f, " + df.format(loc.getPitch()) + "f)";
    }
